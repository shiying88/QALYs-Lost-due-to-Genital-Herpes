from supports.DemographicValuesSupport import *
...
df_life_table_male = get_clean_life_table(
    path='/Users/shiyingyou/PycharmProjects/HSV-QALY/New_HSV_tree/data/US_man_lifetable2017_CDC.csv')
df_life_table_female = get_clean_life_table(
    path='/Users/shiyingyou/PycharmProjects/HSV-QALY/New_HSV_tree/data/US_women_lifetable2017_CDC.csv')
df_life_table = get_clean_life_table(
    path='/Users/shiyingyou/PycharmProjects/HSV-QALY/New_HSV_tree/data/US_lifetable2015_CDC.csv')
